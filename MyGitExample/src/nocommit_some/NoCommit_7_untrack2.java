...
public class NoCommit_7_untrack2 {
	...
	/*
		...
		3. Commit 을 하고 Push 도 합니다. 
		   Web 의 git Hub 에 가보면 /MyGitExample/src/nocommit_some/NoCommit_7_untrack2.java 파일이 Push 되어 보여집니다.     
        4. 그런 다음에 .gitignore 파일을 열어서 /MyGitExample/src/nocommit_some/NoCommit_7_untrack2.java 을 등록한 후 저장합니다.
        ...
        7. Project Explorer 에 가보면 이제부터 NoCommit_7_untrack2.java 파일은 ignore 상태로 되어집니다.
           ...
           NoCommit_7_untrack2.java 파일이 제외되지 않고 그대로 보여집니다.
                        ...
                        즉, Web 의 git Hub 에 있던 /MyGitExample/src/nocommit_some/NoCommit_7_untrack2.java 파일을 삭제하겠다는 것입니다.                          
        8. Commit 메시지를 쓴 후 Commit 을 하고 Push 를  합니다.
        9. Web 의 git Hub 에 가보면 /MyGitExample/src/nocommit_some/NoCommit_7_untrack2.java 파일이 삭제되어 안 보여집니다.   
